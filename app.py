...
try:
    ...
    print("Warning: Categorization model files not found or empty!")
...
try:
    ...
    print("Warning: Job recommendation model files not found or empty!")
...
def predict_category(resume_text):
    if rf_classifier_categorization is None or tfidf_vectorizer_categorization is None:
        return "Model not loaded - Category prediction unavailable"
...
def job_recommendation(resume_text):
    if rf_classifier_job_recommendation is None or tfidf_vectorizer_job_recommendation is None:
        return "Model not loaded - Job recommendation unavailable"
...
def pred():
    ...
    if 'resume' in request.files:
        ...
        if filename.endswith('.pdf'):
            ...
            return render_template('resume.html', message="Invalid file format. Please upload a PDF or TXT file.", error=True)

        # Clean the resume text for processing
        cleaned_text = cleanResume(text)
        
        # Get predictions and information
        ...
        job_matches = get_job_matches(cleaned_text, skills, education)
        ...
        return render_template('resume.html', message="No resume file uploaded. Please upload a PDF or TXT file.", error=True)
